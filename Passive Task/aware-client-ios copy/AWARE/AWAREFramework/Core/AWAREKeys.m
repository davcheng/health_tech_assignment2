...
//dave's code
//NSString* const SENSOR_PLUGIN_CHEMO_BRAIN = @"plugin_chemo_brain";
NSString* const SENSOR_PLUGIN_CHEMO_BRAIN = @"plugin_ios_activity_recognition";
...
// Chemo Brain
NSString * const ACTION_AWARE_CHEMO_BRAIN = @"ACTION_AWARE_CHEMO_BRAIN";
