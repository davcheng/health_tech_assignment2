...
//    }
    ...
    //chemo brain addition
    /** [Additional sensors] */
    awareSensor = [[ChemoBrainSensor alloc] initWithAwareStudy:awareStudy dbType:dbType];
    [awareSensor startSensorWithSettings:nil];
    [self addNewSensor:awareSensor];
    // end chemo brain addition
